\documentclass{plain-cv} % Use the resume class

% Your name to appear at the top
\setname{Stelle}
% You can use the \address command up to 3 times for 3 different addresses or pieces of contact information
% Any new lines (\\) you use in the \address commands will be converted to symbols, so each address will appear as a single line.

\address{122485601	\qquad	\href{mailto:hi@icey.one}{hi@icey.one} \quad {星穹列车 005 号}} % Contact information

%----------------------------------------------------------------------------------------

\begin{document}

% If you do not need an avatar, please comment out the code below
