...
% 自定义颜色
\definecolor{customcolor}{RGB}{40,67,60} % 该颜色取自校徽

% 自定义命令
\newcommand{\aLogo}{\includegraphics[width=0.15\textwidth]{images/zzu_logo.png}} % 页眉校徽
\newcommand{\bLogo}{\includegraphics[width=0.75\textwidth]{images/zzu_logo_big.png}} % 底纹水印
\newcommand{\school}{数学与统计学院} %页眉参数
\newcommand{\contact}{\textcolor{white}{\textbf{求是 \quad 担当}}} %页脚参数
