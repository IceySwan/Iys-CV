...
% aroma CV LaTeX Template for Cover Letter
%
...
\documentclass[11pt, a4paper]{aroma-cv}

% Configure page margins with geometry
\geometry{left=1.4cm, top=.8cm, right=1.4cm, bottom=1.8cm, footskip=.5cm}

% Color for highlights
% aroma Colors: aroma-emerald, aroma-skyblue, aroma-red, aroma-pink, aroma-orange
%                 aroma-nephritis, aroma-concrete, aroma-darknight
\colorlet{aroma}{aroma-red}
% Uncomment if you would like to specify your own color
% \definecolor{aroma}{HTML}{CA63A8}
...
% Set false if you don't want to highlight section with aroma color
